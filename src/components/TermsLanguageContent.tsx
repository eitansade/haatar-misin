...
const hebrewTerms = [
  ["תקנון שימוש ובטיחות", "ברוכים הבאים ל־CareKids Israel. השימוש באתר, במוצרים ובשירותים המוצעים בו כפוף לתנאים המפורטים בתקנון זה. גלישה באתר או רכישת מוצר מהווים הסכמה לתנאים אלו."],
  ...
  ["קניין רוחני", "כל זכויות היוצרים, העיצובים, הטקסטים, הלוגואים, הגרפיקות והתכנים באתר שייכים ל־CareKids Israel ואין להעתיק, לשכפל או להשתמש בהם ללא אישור מראש ובכתב."],
...
const englishTerms = [
  ["Terms of Use and Safety", "Welcome to CareKids Israel. Use of this website, products, and services is subject to these terms. Browsing the website or purchasing a product constitutes acceptance of these terms."],
  ...
  ["Intellectual Property", "All copyrights, designs, texts, logos, graphics, and website content belong to CareKids Israel and may not be copied, duplicated, or used without prior written permission."],
